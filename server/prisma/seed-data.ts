...
// their identities: deepika@example.com / anand@example.com (customers) and
// ravi.kumar@example.com / rajesh.kannan@example.com (workers).
export const customers: CustomerSeed[] = [
  { id: "cust-1", name: "Anand Verma", email: "anand@example.com", phone: "9876543210", address: "12, Kasturba Gandhi Marg, Connaught Place, New Delhi", lng: 77.2167, lat: 28.6315, city: "Delhi", joinedDaysAgo: 412 },
  { id: "cust-2", name: "Deepika Ramaswamy", email: "deepika@example.com", phone: "8765432109", address: "54, Gandhi Nagar Main Road, Adyar, Chennai", lng: 80.2569, lat: 13.0064, city: "Chennai", joinedDaysAgo: 388 },
  { id: "cust-3", name: "Sundar Rajagopal", email: "sundar.rajagopal@example.com", phone: "9840112207", address: "8/3, Rajaji Street, Chromepet, Chennai", lng: 80.1417, lat: 12.9516, city: "Chennai", joinedDaysAgo: 301 },
  { id: "cust-4", name: "Fathima Nasreen", email: "fathima.nasreen@example.com", phone: "9884503318", address: "22, Thillai Ganga Nagar, Nanganallur, Chennai", lng: 80.1892, lat: 12.9803, city: "Chennai", joinedDaysAgo: 264 },
  { id: "cust-5", name: "Gopinath Sekar", email: "gopinath.sekar@example.com", phone: "9790224419", address: "141, Velachery Main Road, Velachery, Chennai", lng: 80.2206, lat: 12.9791, city: "Chennai", joinedDaysAgo: 233 },
  { id: "cust-6", name: "Janaki Murugesan", email: "janaki.murugesan@example.com", phone: "9566318824", address: "3, Bharathi Salai, Tambaram West, Chennai", lng: 80.1063, lat: 12.9249, city: "Chennai", joinedDaysAgo: 198 },
  { id: "cust-7", name: "Aravind Chellappa", email: "aravind.chellappa@example.com", phone: "9500712236", address: "76, Lattice Bridge Road, Thiruvanmiyur, Chennai", lng: 80.2596, lat: 12.9829, city: "Chennai", joinedDaysAgo: 176 },
  { id: "cust-8", name: "Nithya Balasubramanian", email: "nithya.bala@example.com", phone: "9840667751", address: "19, Kamarajar Street, Porur, Chennai", lng: 80.1565, lat: 13.0359, city: "Chennai", joinedDaysAgo: 149 },
  { id: "cust-9", name: "Hari Prasad Iyer", email: "hari.prasad@example.com", phone: "9789045512", address: "5, Ambedkar Nagar 2nd Street, Pallavaram, Chennai", lng: 80.1491, lat: 12.9675, city: "Chennai", joinedDaysAgo: 121 },
  { id: "cust-10", name: "Shalini Vaidyanathan", email: "shalini.v@example.com", phone: "9962238804", address: "27, Ramaniyam Enclave, Sholinganallur, Chennai", lng: 80.2279, lat: 12.9010, city: "Chennai", joinedDaysAgo: 96 },
  { id: "cust-11", name: "Mohan Krishnamurthy", email: "mohan.krishnamurthy@example.com", phone: "9445127739", address: "64, MTH Road, Ambattur, Chennai", lng: 80.1548, lat: 13.1143, city: "Chennai", joinedDaysAgo: 74 },
  { id: "cust-12", name: "Rukmini Desai", email: "rukmini.desai@example.com", phone: "9820441167", address: "402, Sai Darshan CHS, Andheri East, Mumbai", lng: 72.8697, lat: 19.1197, city: "Mumbai", joinedDaysAgo: 203 },
  { id: "cust-13", name: "Imran Qureshi", email: "imran.qureshi@example.com", phone: "9811336720", address: "B-14, Lajpat Nagar II, New Delhi", lng: 77.2432, lat: 28.5677, city: "Delhi", joinedDaysAgo: 158 },
  { id: "cust-14", name: "Chaitra Hegde", email: "chaitra.hegde@example.com", phone: "9740558812", address: "18, 12th Main, Indiranagar, Bengaluru", lng: 77.6408, lat: 12.9716, city: "Bengaluru", joinedDaysAgo: 112 }
];

export const workers: WorkerSeed[] = [
  // Chennai — Chennai Skilled Workers Cooperative (coop-1)
  { mockId: "worker-1", name: "Ravi Kumar", email: "ravi.kumar@example.com", phone: "9876543211", skill: "plumbing", extraSkills: ["domesticHelp"], experience: 6, location: "Adyar, Chennai", lng: 80.2565, lat: 13.0012, cooperativeId: "coop-1", city: "Chennai", availabilityStatus: "AVAILABLE", verification: "APPROVED", joinedDaysAgo: 505, serviceRadiusKm: 12 },
  { mockId: "worker-2", name: "Priya Shanmugam", email: "priya.shanmugam@example.com", phone: "8765432112", skill: "plumbing", experience: 5, location: "Mylapore, Chennai", lng: 80.2707, lat: 13.0339, cooperativeId: "coop-1", city: "Chennai", availabilityStatus: "AVAILABLE", verification: "APPROVED", joinedDaysAgo: 468, serviceRadiusKm: 10 },
  { mockId: "worker-7", name: "Rajesh Kannan", email: "rajesh.kannan@example.com", phone: "9210987617", skill: "electrical", experience: 9, location: "Velachery, Chennai", lng: 80.2209, lat: 12.9756, cooperativeId: "coop-1", city: "Chennai", availabilityStatus: "AVAILABLE", verification: "APPROVED", joinedDaysAgo: 522, serviceRadiusKm: 15 },
  { mockId: "worker-9", name: "Saravanan Pandian", email: "saravanan.pandian@example.com", phone: "9840775513", skill: "electrical", extraSkills: ["carpentry"], experience: 13, location: "Tambaram, Chennai", lng: 80.1063, lat: 12.9249, cooperativeId: "coop-1", city: "Chennai", availabilityStatus: "ON_JOB", verification: "APPROVED", joinedDaysAgo: 431, serviceRadiusKm: 18 },
  { mockId: "worker-10", name: "Kavitha Raman", email: "kavitha.raman@example.com", phone: "9500334421", skill: "cleaning", experience: 4, location: "Chromepet, Chennai", lng: 80.1417, lat: 12.9516, cooperativeId: "coop-1", city: "Chennai", availabilityStatus: "AVAILABLE", verification: "APPROVED", joinedDaysAgo: 287, serviceRadiusKm: 9 },
  { mockId: "worker-11", name: "Murugan Thangavel", email: "murugan.thangavel@example.com", phone: "9789112234", skill: "carpentry", experience: 16, location: "Pallavaram, Chennai", lng: 80.1491, lat: 12.9675, cooperativeId: "coop-1", city: "Chennai", availabilityStatus: "AVAILABLE", verification: "APPROVED", joinedDaysAgo: 612, serviceRadiusKm: 14 },
  { mockId: "worker-12", name: "Selvi Manoharan", email: "selvi.manoharan@example.com", phone: "9962007745", skill: "caregiving", extraSkills: ["domesticHelp"], experience: 11, location: "Thiruvanmiyur, Chennai", lng: 80.2596, lat: 12.9829, cooperativeId: "coop-1", city: "Chennai", availabilityStatus: "ON_JOB", verification: "APPROVED", joinedDaysAgo: 354, serviceRadiusKm: 8 },
  { mockId: "worker-13", name: "Dinesh Karthik Raja", email: "dinesh.raja@example.com", phone: "9445886620", skill: "painting", experience: 7, location: "Porur, Chennai", lng: 80.1565, lat: 13.0359, cooperativeId: "coop-1", city: "Chennai", availabilityStatus: "AVAILABLE", verification: "APPROVED", joinedDaysAgo: 265, serviceRadiusKm: 16 },
  { mockId: "worker-14", name: "Anitha Jeyaraman", email: "anitha.jeyaraman@example.com", phone: "9840229917", skill: "cleaning", extraSkills: ["domesticHelp"], experience: 3, location: "Velachery, Chennai", lng: 80.2206, lat: 12.9791, cooperativeId: "coop-1", city: "Chennai", availabilityStatus: "OFF_DUTY", verification: "APPROVED", joinedDaysAgo: 191, serviceRadiusKm: 7 },
  { mockId: "worker-15", name: "Bhaskaran Ilango", email: "bhaskaran.ilango@example.com", phone: "9790556631", skill: "gardening", experience: 18, location: "Sholinganallur, Chennai", lng: 80.2279, lat: 12.9010, cooperativeId: "coop-1", city: "Chennai", availabilityStatus: "AVAILABLE", verification: "APPROVED", joinedDaysAgo: 702, serviceRadiusKm: 20 },
  { mockId: "worker-16", name: "Yuvaraj Elangovan", email: "yuvaraj.elangovan@example.com", phone: "9566774428", skill: "plumbing", experience: 2, location: "Ambattur, Chennai", lng: 80.1548, lat: 13.1143, cooperativeId: "coop-1", city: "Chennai", availabilityStatus: "AVAILABLE", verification: "PENDING", joinedDaysAgo: 21, serviceRadiusKm: 10 },
  { mockId: "worker-17", name: "Revathi Subramani", email: "revathi.subramani@example.com", phone: "9500661132", skill: "domesticHelp", experience: 8, location: "Nanganallur, Chennai", lng: 80.1892, lat: 12.9803, cooperativeId: "coop-1", city: "Chennai", availabilityStatus: "AVAILABLE", verification: "APPROVED", joinedDaysAgo: 329, serviceRadiusKm: 9 },
  { mockId: "worker-18", name: "Karthikeyan Velu", email: "karthikeyan.velu@example.com", phone: "9840338826", skill: "painting", extraSkills: ["carpentry"], experience: 12, location: "Guindy, Chennai", lng: 80.2206, lat: 13.0067, cooperativeId: "coop-1", city: "Chennai", availabilityStatus: "AVAILABLE", verification: "APPROVED", joinedDaysAgo: 447, serviceRadiusKm: 17 },
  { mockId: "worker-19", name: "Sasikala Perumal", email: "sasikala.perumal@example.com", phone: "9789443317", skill: "caregiving", experience: 6, location: "Medavakkam, Chennai", lng: 80.1929, lat: 12.9180, cooperativeId: "coop-1", city: "Chennai", availabilityStatus: "AVAILABLE", verification: "PENDING", joinedDaysAgo: 9, serviceRadiusKm: 11 },

  // Delhi — Delhi Household & Labor Union (coop-2)
  { mockId: "worker-3", name: "Amit Singh", email: "amit.singh@example.com", phone: "7654321213", skill: "plumbing", experience: 8, location: "Connaught Place, New Delhi", lng: 77.2167, lat: 28.6315, cooperativeId: "coop-2", city: "Delhi", availabilityStatus: "AVAILABLE", verification: "APPROVED", joinedDaysAgo: 553, serviceRadiusKm: 14 },
  { mockId: "worker-20", name: "Harpreet Kaur", email: "harpreet.kaur@example.com", phone: "9811224436", skill: "cleaning", extraSkills: ["domesticHelp"], experience: 5, location: "Lajpat Nagar, New Delhi", lng: 77.2432, lat: 28.5677, cooperativeId: "coop-2", city: "Delhi", availabilityStatus: "AVAILABLE", verification: "APPROVED", joinedDaysAgo: 274, serviceRadiusKm: 12 },
  { mockId: "worker-21", name: "Naveen Chandra Joshi", email: "naveen.joshi@example.com", phone: "9871556624", skill: "electrical", experience: 15, location: "Karol Bagh, New Delhi", lng: 77.1906, lat: 28.6519, cooperativeId: "coop-2", city: "Delhi", availabilityStatus: "OFF_DUTY", verification: "APPROVED", joinedDaysAgo: 638, serviceRadiusKm: 16 },

  // Mumbai — Mumbai Community & Caregivers Society (coop-3)
  { mockId: "worker-4", name: "Vikram Rathore", email: "vikram.rathore@example.com", phone: "9543210914", skill: "plumbing", experience: 4, location: "Andheri East, Mumbai", lng: 72.8697, lat: 19.1197, cooperativeId: "coop-3", city: "Mumbai", availabilityStatus: "AVAILABLE", verification: "APPROVED", joinedDaysAgo: 318, serviceRadiusKm: 11 },
  { mockId: "worker-8", name: "Meena Kumari", email: "meena.kumari@example.com", phone: "9109876518", skill: "caregiving", extraSkills: ["cleaning"], experience: 5, location: "Bandra West, Mumbai", lng: 72.8296, lat: 19.0596, cooperativeId: "coop-3", city: "Mumbai", availabilityStatus: "AVAILABLE", verification: "APPROVED", joinedDaysAgo: 366, serviceRadiusKm: 10 },

  // Bengaluru — Bangalore Technicians Cooperative Board (coop-4)
  { mockId: "worker-6", name: "Lakshmi Narayanan", email: "lakshmi.narayanan@example.com", phone: "9321098716", skill: "carpentry", extraSkills: ["painting"], experience: 7, location: "Indiranagar, Bengaluru", lng: 77.6408, lat: 12.9716, cooperativeId: "coop-4", city: "Bengaluru", availabilityStatus: "AVAILABLE", verification: "APPROVED", joinedDaysAgo: 402, serviceRadiusKm: 13 },
  { mockId: "worker-22", name: "Shivakumar Gowda", email: "shivakumar.gowda@example.com", phone: "9740117725", skill: "electrical", experience: 10, location: "Koramangala, Bengaluru", lng: 77.6245, lat: 12.9352, cooperativeId: "coop-4", city: "Bengaluru", availabilityStatus: "AVAILABLE", verification: "APPROVED", joinedDaysAgo: 239, serviceRadiusKm: 15 }
];
